...
import SyncOtpPage from "src/pages/Login/SyncOtpPage";
        ...
        <>
          <Route path="/" element={<AppLayout />}>
            ...
            <Route path="hbac-rules">
              ...
              <Route path=":cn">
                <Route path="" element={<HBACRulesTabs section="settings" />} />
              </Route>
            </Route>
            ...
            <Route path="hbac-services">
              ...
              <Route path=":cn">
                ...
                <Route
                  ...
                  element={<HBACServicesTabs section="memberof_hbacsvcgroup" />}
                />
              </Route>
            </Route>
            ...
            <Route path="sudo-commands">
              ...
              <Route path=":sudocmd">
                <Route path="" element={<SudoCmdsTabs section="settings" />} />
                <Route
            ...
            <Route path="otp-tokens">
              ...
              <Route path=":ipatokenuniqueid">
                <Route path="" element={<OtpTokensTabs section="settings" />} />
                <Route
                  path="managedby_user"
            ...
            <Route path="id-ranges">
              ...
              <Route path=":cn">
                <Route path="" element={<IdRangesTabs section="settings" />} />
              </Route>
            </Route>
            <Route path="trusts">
